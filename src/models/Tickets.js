...
const TicketSchema = new mongoose.Schema({
  ...
  impact_step3:     { type: String }, 
                                       // Impact assessment step 3
  root_cause_step4:   { type: String },                                      // Findings from investigation step 4
  corrective_actions_step5: { type: String }                                       // Root cause analysis step 5
}, {
